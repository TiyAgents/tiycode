...
const BUILTIN_COMMANDS: ReadonlyArray<ComposerCommandDescriptor> = [
  ...
  },
  {
    ...
    name: "goal",
    path: "/goal",
    description: "Persistent goal: set objective, pause, resume, check status, or clear",
    argumentHint: "<objective> | pause | resume | status | clear",
  ...
  },
  {
    ...
    name: "goal-pause",
    path: "/goal-pause",
    description: "Pause the current persistent goal",
    argumentHint: "",
    prompt: "",
    behavior: "goal",
    smartSend: "always",
  },
  {
    ...
    name: "goal-resume",
    path: "/goal-resume",
    description: "Resume a paused persistent goal",
    argumentHint: "",
    prompt: "",
    behavior: "goal",
    smartSend: "always",
  },
  {
    ...
    name: "goal-clear",
    path: "/goal-clear",
    description: "Clear (delete) the current persistent goal",
    argumentHint: "",
    prompt: "",
    behavior: "goal",
    smartSend: "always",
  },
  {
    ...
    name: "goal-status",
    path: "/goal-status",
    description: "Show current persistent goal status",
    argumentHint: "",
    prompt: "",
    behavior: "goal",
    smartSend: "always",
