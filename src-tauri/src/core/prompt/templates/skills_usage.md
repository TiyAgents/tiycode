...
- How to use a skill (progressive disclosure):
  1. After deciding to use a skill, open its `SKILL.md`. Before using a skill, read its `SKILL.md` completely unless the file is clearly only metadata plus links and the relevant workflow section has been fully loaded.
