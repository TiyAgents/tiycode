...
const TEMPLATE_REL_PATH: &str = "behavioral_guidelines.md";
const TEMPLATE_EMBEDDED: &str = include_str!("../templates/behavioral_guidelines.md");
const DECLARED_KEYS: &[&'static str] = &[];

pub struct BehavioralGuidelinesSource {
    spec_version: u32,
}

impl BehavioralGuidelinesSource {
...
#[async_trait]
impl SectionSource for BehavioralGuidelinesSource {
    fn source_kind(&self) -> &'static str {
        "template:behavioral_guidelines.md"
    }
