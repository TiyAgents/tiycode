...
//!
//! Coverage:
//! - Tool call persistence and status tracking (CRUD, approval, rejection)
//! - Policy verdict JSON storage
//! - Audit event recording
//! - Pending tool calls index
//! - Helper-safe approval escalation
//! - Search tool execution (relative dirs, wildcards, regex, count mode, timeout)
